...
always @(*) begin
  case (log1_sel1)
    ...
    3'd1: log1_op1_r = i2;
    3'd2: log1_op1_r = i3;
    3'd3: log1_op1_r = reg_n2;
    3'd4: log1_op1_r = reg_n4;
    3'd5: log1_op1_r = reg_n5;
    3'd6: log1_op1_r = reg_n6;
    3'd7: log1_op1_r = reg_n7;
...
always @(*) begin
  case (log1_sel2)
    ...
    3'd1: log1_op2_r = i2;
    3'd2: log1_op2_r = i3;
    3'd3: log1_op2_r = reg_n2;
    3'd4: log1_op2_r = reg_n4;
    3'd5: log1_op2_r = reg_n5;
    3'd6: log1_op2_r = reg_n6;
    3'd7: log1_op2_r = reg_n7;
